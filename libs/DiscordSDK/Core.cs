...
namespace Discord
{
    ...
    {
        public Result InstanceResult { get; private set; }
        public Result CallbacksResult { get; private set; }
        ...
        public Discord(Int64 clientId, UInt64 flags)
        {
            ...
            InstanceResult = DiscordCreate(3, ref createParams, out MethodsPtr);
            if (InstanceResult != Result.Ok)
            {
                Dispose();
            }
        }
        ...
        public void Dispose()
        {
            if (MethodsPtr != IntPtr.Zero)
            {
                if (CallbacksResult != Result.NotRunning)
                {
        ...
        {
            CallbacksResult = Methods.RunCallbacks(MethodsPtr);
        }
